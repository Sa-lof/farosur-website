...
const clientsData = [
  {
    title: "BAROCCO",
    description: "Marca mexicana creada en el año 2006, por Ruth Ramírez, quien cuenta con una maestría en Artes Visuales y experiencia de 20 años en el ramo. La marca está dirigida a mujeres latinas y tiene una cadena de valor que incluye el proceso completo; desde el diseño de los estampados, hasta la distribución y venta en varios estados de la República Mexicana, a través de 'El Palacio de Hierro'.",
    image: client1
  },
  {
    title: "LIECH ANTEL",
    description: "Creada por la diseñadora mexicana del mismo nombre. Actualmente la marca está presente en los hoteles y concept stores más exclusivos de México y Miami. Ha participado en “fashion shows”, a nivel nacional e internacional como Miami Swim Week, compartiendo pasarela con los mejores diseñadores del mundo y teniendo menciones en medios de prestigio como Forbes, Vogue, ESPN, NYPost, Quien, entre otros.",
    image: client2
  },
  {
    title: "EUROSOL CONCEPT",
    description: "Marca mexicana que crea conceptos de playa para mujeres que buscan funcionalidad y control abdominal. Actualmente la marca es diseñada por Gricelda Zarco y se inspira en la flora y fauna tropical, creando estampados posicionados y exclusivos para la marca.",
    image: client3
  },
];
        ...
        <Grid container spacing={6} justifyContent="center">
          {clientsData.map((client, index) => (
            <Grid item xs={12} sm={6} md={6} lg={4} key={index} sx={{ display: "flex", justifyContent: "center" }}>
              <Card sx={{ boxShadow: "none", maxWidth: 400, backgroundColor: "#F8F7F5" }}>
                <Box
                  sx={{
                    width: '100%',
                    height: 600,
